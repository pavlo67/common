...
func PrepareLinks(userIS common.ID, grpsOp groups.Operator, objectROwner common.ID, linksListOld, linksListNew []links.Item, jointLinks bool, linkTypesOnly ...string) (linkslistFinal []links.Item) {
...
func AddTags(userIS common.ID, o *Item, tags string) {
	if o == nil {
		return
	}
...
func Linked(userIS common.ID, objectsOp Operator, linksOp links.Operator, o *Item) []Item {
