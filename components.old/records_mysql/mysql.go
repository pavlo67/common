...
//	"github.com/pavlo67/workshop/auth"
//	"github.com/pavlo67/workshop/basis/basis"
//	"github.com/pavlo67/workshop/starter/config"
...
//
//func (objOp *notesMySQL) Create(userIS common.ID, o notes.Item) (id string, err error) {
...
//	values := []interface{}{
//		o.GlobalIS, o.Genus,
//		o.Author, strings.TrimSpace(o.Title), o.Visibility,
//		o.Brief, o.Content,
...
//
//func (objOp *notesMySQL) Read(userIS common.ID, idStr string) (*notes.Item, error) {
//	if len(idStr) < 1 {
...
//
//func (objOp *notesMySQL) ReadList(userIS common.ID, options *content.ListOptions) ([]notes.Item, uint64, error) {
//	var err error
...
//func (objOp *notesMySQL) Update(userIS common.ID, o notes.Item) (crud.Result, error) {
...
//
//func (objOp *notesMySQL) Delete(userIS common.ID, id string) (crud.Result, error) {
...
//	if !groups.OneOf(userIS, objOp.grpsOp, common.ID(rOwner0)) {
...
//}
//
//func (objOp *notesMySQL) QueryByPrefix(userIS common.ID, rView common.ID, genus *notes.Genus, prefix string) ([]notes.Asked, error) {
//	return nil, nil
//}
//
...
//
//func (objOp *notesMySQL) ReadListByTag(userIS common.ID, options *content.ListOptions, tag string) (linkedObjs []notes.Item, allCnt uint64, parentIDs []string, err error) {
...
//
//func (objOp *notesMySQL) setLinks(userIS common.ID, idStr string, linksListNew []links.Item) error {
//	var err error
...
////		o, err := fixturer.Row(userIS, fixture.FieldsArr, row, objOp.generaOp)
////		if err != nil {
