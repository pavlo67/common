...
var userISNil auth.ID

func setLinkSteps(userISToSet, userISToSetAnother auth.ID) []SetLinksStep {
	is := userISToSet
...
func QueryTagsByOwnerTestCases(linksOp Operator, userISToSet, userISToSetAnother auth.ID) []QueryTagsByOwnerTestCase {
...
func QueryTagsTestCases(linksOp Operator, userISToSet, userISToSetAnother auth.ID) []QueryTagsTestCase {
...
func QueryByTagTestCases(linksOp Operator, userISToSet, userISToSetAnother auth.ID) []QueryByTagTestCase {
...
func QueryByObjectIDTestCases(linksOp Operator, userISToSet, userISToSetAnother auth.ID) []QueryByObjectIDTestCase {
...
func QueryTestCases(linksOp Operator, userISToSet, userISToSetAnother auth.ID) []QueryTestCase {
