...
func TestAngle(t *testing.T) {
	...
	tests := []struct {
		...
		{args: args{p: Point2{X: 0, Y: 0}}, want: math.NaN()},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := Angle(tt.args.p); math.Abs(got-tt.want) > eps {
				t.Errorf("Angle() = %v, wantDistance %v", got, tt.want)
			}
		})
	}
}
...
//				t.Errorf("Angle() = %v, wantDistance %v", got, tt.wantDistance)
//			}
//		})
//	}
//}
