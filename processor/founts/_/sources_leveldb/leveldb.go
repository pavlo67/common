...
func (srcOp *sourcesMySQL) Create(userIS auth.ID, source sources.Item) (string, error) {
...
func (srcOp *sourcesMySQL) Read(userIS auth.ID, idStr string) (*sources.Item, error) {
...
func (srcOp *sourcesMySQL) ReadList(userIS auth.ID, options *content.ListOptions) ([]sources.Item, uint64, error) {
	var err error
...
func (srcOp *sourcesMySQL) Update(userIS auth.ID, source sources.Item) (crud.Result, error) {
...
func (srcOp *sourcesMySQL) Delete(userIS auth.ID, id string) (crud.Result, error) {
