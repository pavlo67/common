...
type Right string
type Managers map[Right]auth.ID
...
const AllowedForAll auth.ID = "*"
const AllowedForAllAuthorized auth.ID = "!"

//func HasRights(user *auth.User, identOpsMap map[auth.CredsType][]Operator, allowedIDs []auth.ID) (bool, error) {
//	if allowedIDs == nil {
//		return true, nil
