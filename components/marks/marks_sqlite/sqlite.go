...
func (flowOp *flowSQLite) List(errTitle, sqlQuery string, stm *sql.Stmt, values []interface{}, before *time.Time, options *crud.GetOptions) ([]crud.Brief, error) {
	if before == nil {
...
func (flowOp *flowSQLite) ListAll(before *time.Time, options *crud.GetOptions) ([]crud.Brief, error) {
	return flowOp.List("on flowSQLite.ListAll(): ", flowOp.sqlListAll, flowOp.stmListAll, nil, before, options)
}

func (flowOp *flowSQLite) ListByURL(sourceURL string, before *time.Time, options *crud.GetOptions) ([]crud.Brief, error) {
	return flowOp.List("on flowSQLite.ListByURL(): ", flowOp.sqlListByURL, flowOp.stmListByURL, []interface{}{sourceURL}, before, options)
}

func (flowOp *flowSQLite) ListByTag(tag string, before *time.Time, options *crud.GetOptions) ([]crud.Brief, error) {
...
func (flowOp *flowSQLite) Read(idStr common.ID, options *crud.GetOptions) (*importer.Item, error) {
	if len(idStr) < 1 {
...
func (flowOp *flowSQLite) URLs(_ *crud.GetOptions) ([]flow.Part, error) {
...
func (flowOp *flowSQLite) Tags(*crud.GetOptions) ([]flow.Part, error) {
...
func (flowOp *flowSQLite) Save(items []importer.Item, options *crud.SaveOptions) ([]common.ID, error) {
	var ids []common.ID
	var errs common.Errors
